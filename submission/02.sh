...
prevrawtxhex=""

utxo_txid=$(bitcoin-cli -regtest decoderawtransaction $prevrawtxhex | jq -r '.[0] | .txid')
utxo1_vout=$(bitcoin-cli -regtest decoderawtransaction $prevrawtxhex | jq -r '.[0] | .vout')
utxo2_vout=$(bitcoin-cli -regtest decoderawtransaction $prevrawtxhex | jq -r '.[1] | .vout')
